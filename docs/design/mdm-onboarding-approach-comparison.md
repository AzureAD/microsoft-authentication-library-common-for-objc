...
> **Allow `msauth://in_app_enrollement_complete` to propagate to a response object** (do not intercept it for immediate termination or onboarding work at navigation-time).
